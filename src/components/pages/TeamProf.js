...
function TeamProf() {
  return (
    <div className="teamprof">
      ...
      Skills: Collect user's employee information and store them in a database using Inquirer/MySQL, transfer data across API to display HTML cards on team profile generator app.
      </p>
      <p>

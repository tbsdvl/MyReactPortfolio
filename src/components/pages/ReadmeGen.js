...
// README Generator project page component
...
function ReadmeGen() {
  return (
    <div className="readmegen">
      ...
      Technologies: JavaScript, Node.js, Inquirer, Filesystem
      Skills: Code logic to prompt user to enter textual information, use of promises and async/await to delay function calls until user enters necessary data, writing to a file with filesystem.
      </p>
      <p>
